...
const nodes: NodeData[] = [
  {
    ...
    minioFeature: 'Object versioning ensures every dataset iteration is preserved — full audit trail for experiment reproducibility',
    dataVolume: 'GB',
    phase: 1,
  },
  {
    ...
    minioFeature: 'MinIO AIStor delivers 325 GiB/s GET throughput — loads a 140GB model in under 1 second at cluster scale',
    dataVolume: 'GB',
    phase: 1,
  },
  {
  ...
  },
  {
    ...
    minioFeature: 'BitRot protection verifies every byte — even small adapter files get full integrity checking at 10+ GB/s per core',
    dataVolume: 'MB',
    phase: 3,
  },
  {
    ...
    minioFeature: 'MinIO Catalog provides GraphQL search across experiments — find the best adapter config instantly',
    dataVolume: 'MB',
    phase: 3,
  },
  {
    ...
    minioFeature: 'Object Lock ensures adapters are immutable once published — WORM compliance for regulated deployments',
    dataVolume: 'MB',
    phase: 4,
  },
]

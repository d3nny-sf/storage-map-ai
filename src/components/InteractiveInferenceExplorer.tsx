...
const nodes: NodeData[] = [
  {
    ...
    minioFeature: 'MinIO AIStor delivers 325 GiB/s GET throughput — a 140 GB model loads in under 1 second at cluster scale',
    dataVolume: 'GB',
    phase: 1,
  },
  {
    ...
    minioFeature: 'MinIO Cache with distributed DRAM ensures adapter swaps are sub-second — no cold reads from disk',
    dataVolume: 'MB',
    phase: 1,
  },
  {
  ...
  },
  {
    ...
    minioFeature: 'MinIO S3 Select with SIMD acceleration enables fast analytics queries directly on log Parquet files',
    dataVolume: 'TB',
    phase: 3,
  },
  {
    ...
    minioFeature: 'Object versioning tracks every feedback batch — full lineage from user interaction to next fine-tuning round',
    dataVolume: 'GB',
    phase: 3,
  },
  {
    ...
    minioFeature: 'Object Lock ensures model versions are immutable — WORM compliance means you can always roll back with certainty',
    dataVolume: 'GB',
    phase: 4,
  },
]

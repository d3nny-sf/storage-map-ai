...
const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    context: 'Tier 2 uses S3 over RDMA to NVMe at 800 GbE (Spectrum-X / ConnectX-9). Tier G3.5 uses RDMA for sub-ms KV-cache overflow. Benchmark: 325 GiB/s GET throughput on a 32-node cluster.',
    relatedTerms: ['RoCE', 'Tier 2', 'Spectrum-X 800 GbE', 'ConnectX-9'],
    category: 'storage',
  },
  {
    term: 'S3 API',
  ...
  },
  {
    ...
    context: 'Previously a tech preview; now a full standard. Combined with MinIO AIStor on BlueField-4 NVMe, enables direct GPU ← S3 reads for model loading and KV-cache refill at line rate (800 GbE).',
  ...
  },
  {
    ...
    context: 'The STX rack is the physical home of Tier G3.5 — MinIO AIStor runs on BF-4 NVMe inside the rack, co-located with GPUs for sub-ms RDMA. Think "converged infrastructure for AI" — not disaggregated.',
    relatedTerms: ['Vera Rubin', 'BlueField-4 SuperNIC', 'Spectrum-X 800 GbE', 'Tier G3.5'],
    category: 'storage',
  },
  {
